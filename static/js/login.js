...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (window.location.pathname === "/login_wrong_login.html") {
        let error_message = document.createElement("p"), input_wrapper = document.querySelectorAll(".form__input_wrapper")[0];
    ...
    if (window.location.pathname === "/login_wrong_password.html") {
        let error_message = document.createElement("p"), input_wrapper = document.querySelectorAll(".form__input_wrapper")[1];
        error_message.classList.add("error_message", "form__input_error");
